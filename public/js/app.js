                ...
                json.cities.forEach(function(element) {
                    ...
                    if (result === true) {
                        ...
                        var div = document.createElement('div');
                            div.innerHTML = '<li class="city-wrap"><a href="//google.com/search?q=' + element.name + '" target="_blank" class="city-name"><b>' + element.name + '</b></a> <p>In ' + element.subdivision + ', population is '+ element.population + ', status "' + element.status + '"</p></li>';
